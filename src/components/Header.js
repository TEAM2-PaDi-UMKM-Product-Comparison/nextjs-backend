...
const Header = () => {
  return (
    <header className="bg-white p-0 shadow-md">
      <div className="w-full bg-gray-200"> {/* Div ini menjadi satu garis penuh dengan warna abu-abu muda */}
        <div className="container ml-4 flex justify-start items-left space-x-5 py-4"> {/* Konten di dalamnya */}
